...
COMPLETE_HISTORICAL_DATA = {
    "SET_1": [5, 8, 12, 29, 39, 44],
    "SET_2": [4, 11, 17, 25, 37, 52],
    "SET_3": [3, 6, 30, 42, 45, 49],
    "SET_4": [11, 12, 17, 29, 40, 48],
    "SET_5": [17, 23, 30, 43, 45, 48],
    "SET_6": [6, 7, 28, 32, 42, 45],
    "SET_7": [5, 26, 28, 35, 41, 48],
    "SET_8": [6, 9, 14, 21, 39, 45],
    "SET_9": [13, 15, 24, 35, 41, 45],
    "SET_10": [1, 7, 11, 17, 38, 49],
}
...
for window_idx in range(num_windows):
    window_keys = keys[window_idx + 1: window_idx + 1 + window_size]
    window_data = {}
