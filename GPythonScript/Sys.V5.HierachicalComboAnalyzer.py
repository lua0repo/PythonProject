"SET_54": [10, 26, 36, 43, 44, 48],
"SET_55": [1, 9, 30, 32, 34, 42],
"SET_56": [30, 31, 34, 44, 45, 48],
"SET_57": [9, 36, 37, 42, 43, 45],
"SET_58": [10, 13, 19, 26, 30, 32],
"SET_59": [7, 17, 21, 25, 32, 45],
"SET_60": [4, 6, 21, 24, 33, 49],
}
set_names = list(historical_data.keys())
all_sets = list(historical_data.values())
# Custom Linear Regression class (updated to return scalar for single prediction)
...
# -------------------------------
# DIFFERENCES BETWEEN CONSECUTIVE SETS (Enhanced with per-column regression on diffs)
# -------------------------------
...
# -------------------------------
# CUSTOM KNN-LIKE PREDICTOR (Enhanced with position-based averaging and weighting)
# -------------------------------
...
print(f"\n✅Predicted Group Combination (KNN-like) => {predicted_knn}")

# ML-like prediction
predicted_ml = ml_predict_combination(pairs)
print(f"\n✅Predicted Group Combination (ML-like) => {predicted_ml}")
...
print("\nPredicted Combination Segment (based on weighted frequency):")
...
print(f"\n✅ Best Predicted Set: {' '.join(map(str, best_predicted_set))}")
# ====================================
...
def print_set_analysis(lst):
    if not lst: return
    header = f"{'Set Name':<4} | {'Set Values':<4} | {'1st Alt':>2} | {'2nd Alt':>2} | {'Odd':>2} | {'Even':>2} | {'COdd':>2} | {'CEven':>2} | {'Total':>2}"
    sep = "="*len(header)
    print(sep); print(header); print(sep)
    for d in lst:
        vs = ", ".join(map(str,d['values']))
        print(f"{d['name']:<4} | {vs:<4} | {d['1st_alt']:>2} | {d['2nd_alt']:>2} | {d['odd']:>2} | {d['even']:>2} | {d['codd']:>2} | {d['ceven']:>2} | {d['total']:>2}")
    ...
    if lst:
        ...
        print(f"{pred_name:<4} | {pred_values:<4} | {pred_stats['1st_alt']:>2} | {pred_stats['2nd_alt']:>2} | {pred_stats['odd']:>2} | {pred_stats['even']:>2} | {pred_stats['codd']:>2} | {pred_stats['ceven']:>2} | {pred_stats['total']:>2}")
    print(sep)
...
print(f"\n✅ NEVER DRAWN ELEMENTS: {never_drawn}")
...
print(f"\n✅ BALANCED ANTICIPATION: {anticipated_balanced}")
...
print(f"✅📝Reusable pre_Deff_set: {pre_Deff_set}")
print(f"✅📝Predicted E & O => {pre_EandO_set}")
print(f"✅📝Predicted SET_{next_set_number} Based on KNN logic => {prediction_AN}")
print(f"✅📝Ball Frequency Position => {Bmost_frequent_numbers}")
print(f"✅G for 60 SET3️⃣🎯Reuse 1st_Anticipated: {prediction_1st}")
print(f"✅📝Predicted Group Combination => {predictedPair}")
print(f"✅📝Predicted numbers : {ups_pred}")
print(f"✅G for 20/60 SET3️⃣🎯⭐Anticipating SET_N: {pred_set}")
